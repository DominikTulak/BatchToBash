...
{
    class mkdir : INotifyPropertyChanged
    {
        ...
        public bool sudo { get { return _sudo; } set { if (_sudo != value) { _sudo = value; PropertyChanged(this, new PropertyChangedEventArgs("sudo")); output = Model.Files.mkdir(inputText, sudo); } } }
        ...
        public string inputText
        {
            ...
            set
            {
                ...
                {
                    _inputText = value;
                    output = Model.Files.mkdir(_inputText, sudo);
