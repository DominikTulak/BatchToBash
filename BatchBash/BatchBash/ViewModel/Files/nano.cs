...
{
    class nano : INotifyPropertyChanged
    {
        ...
        public bool sudo { get { return _sudo; } set { if (_sudo != value) { _sudo = value; PropertyChanged(this, new PropertyChangedEventArgs("sudo")); output = Model.Files.nano(inputText, sudo); } } }
        ...
        public string inputText
        {
            ...
            set
            {
                ...
                {
                    _inputText = value;
                    output = Model.Files.nano(_inputText, sudo);
