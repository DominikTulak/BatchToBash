...
{
    class adduser : INotifyPropertyChanged
    {
        ...
        public bool sudo { get { return _sudo; } set { if (_sudo != value) { _sudo = value; PropertyChanged(this, new PropertyChangedEventArgs("sudo")); output = Model.Accounts.adduser(inputText, sudo); } } }
        ...
        public string inputText
        {
            ...
            set
            {
                ...
                {
                    _inputText = value;
                    output = Model.Accounts.adduser(_inputText, sudo);
