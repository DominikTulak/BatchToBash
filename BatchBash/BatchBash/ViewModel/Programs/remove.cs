...
namespace BatchBash.ViewModel.Programs
{
    class remove : INotifyPropertyChanged
    {
        ...
        public bool sudo { get { return _sudo; } set { if (_sudo != value) { _sudo = value; PropertyChanged(this, new PropertyChangedEventArgs("sudo")); output = Model.Programs.remove(inputText, sudo); } } }
        ...
        public string inputText
        {
            ...
            set
            {
                ...
                {
                    _inputText = value;
                    output = Model.Programs.remove(_inputText, sudo);
