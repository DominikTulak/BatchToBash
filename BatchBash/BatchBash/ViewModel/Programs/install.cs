...
{
    class install : INotifyPropertyChanged
    {
        ...
        public bool sudo { get { return _sudo; } set { if (_sudo != value) { _sudo = value; PropertyChanged(this, new PropertyChangedEventArgs("sudo")); output = Model.Programs.install(inputText, sudo); } } }
        ...
        public string inputText
        {
            ...
            set
            {
                ...
                {
                    _inputText = value;
                    output = Model.Programs.install(_inputText, sudo);
